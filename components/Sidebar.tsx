...
const getNavSections = (t: any, ar: boolean): NavSection[] => [
    {
        id: 'overview',
        label: ar ? 'القيادة' : 'Overview',
        items: [
            { id: 'dashboard', icon: 'fa-home', label: t.nav.dashboard },
            { id: 'calendar', icon: 'fa-calendar-alt', label: t.nav.calendar },
            { id: 'analytics', icon: 'fa-chart-pie', label: t.nav.analytics },
        ],
    },
    {
        id: 'publish',
        label: ar ? 'الإنشاء والنشر' : 'Create & Publish',
        items: [
            {
                id: 'social-ops',
                icon: 'fa-share-alt',
                label: ar ? 'السوشيال ميديا' : 'Social Ops',
                children: [
                    { id: 'social-ops/publisher', icon: 'fa-paper-plane', label: ar ? 'نشر محتوى' : t.nav.publisher },
                    { id: 'social-ops/scheduled', icon: 'fa-clock', label: ar ? 'المنشورات المجدولة' : 'Scheduled' },
    ...
    {
        id: 'growth',
        label: ar ? 'النمو والتحسين' : 'Growth & Optimize',
        items: [
            { id: 'ads-ops', icon: 'fa-bullhorn', label: ar ? 'الإعلانات المدفوعة' : t.nav.ads },
            { id: 'seo-ops', icon: 'fa-search-location', label: ar ? 'تحسين محركات البحث' : t.nav.seo },
            { id: 'brand-hub', icon: 'fa-gem', label: ar ? 'هوية البراند' : 'Brand Hub' },
            { id: 'brand-analysis', icon: 'fa-magnifying-glass-plus', label: ar ? 'تحليل البراند' : 'Brand Analysis' },
            { id: 'workflow', icon: 'fa-cogs', label: ar ? 'سير العمل' : t.nav.workflows },
        ],
    },
    {
        id: 'sales-crm',
        label: ar ? 'إدارة المبيعات' : 'Sales CRM',
        items: [
            { id: 'crm/dashboard', icon: 'fa-chart-pie', label: ar ? 'لوحة القيادة' : 'Dashboard' },
            { id: 'crm/customers', icon: 'fa-users', label: ar ? 'قاعدة العملاء' : 'Customers' },
            { id: 'crm/pipeline', icon: 'fa-funnel-dollar', label: ar ? 'مسار المبيعات' : 'Pipeline' },
        ],
    },
    {
        id: 'support-ops',
        label: ar ? 'الدعم العملياتي' : 'Support Ops',
        items: [
            { id: 'inbox', icon: 'fa-inbox', label: ar ? 'إدارة الرسائل' : 'Message Inbox' },
