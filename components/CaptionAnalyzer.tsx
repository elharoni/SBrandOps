...
import { analyzeCaptionForBrandVoice, suggestHashtags } from '../services/geminiService';
...
export const CaptionAnalyzer: React.FC<CaptionAnalyzerProps> = ({ caption, platforms, onClose, brandProfile }) => {
