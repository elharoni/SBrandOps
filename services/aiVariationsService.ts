...
export interface VariationOptions {
    ...
    tones?: string[]; // 'professional', 'casual', 'humorous', 'urgent', 'friendly'
    count?: number;
    brandVoice?: string;
}

/**
 * توليد نسخ متعددة من المحتوى
 */
                        ...
                        variations: {
                            ...
                            items: {
                                ...
                                properties: {
                                    ...
                                    content: {
                                        type: Type.STRING,
                                        description: 'المحتوى المُعاد صياغته'
                                    },
                                    tone: {
                                        type: Type.STRING,
                                        description: 'نبرة المحتوى (professional, casual, humorous, etc.)'
                                    },
                                    length: {
                                        type: Type.STRING,
                                        description: 'طول المحتوى: short, medium, أو long'
                                    },
                                    score: {
                                        type: Type.NUMBER,
                                        description: 'تقييم الجودة من 1-10'
                                    }
                                },
...
/**
 * إعادة صياغة المحتوى بنبرة مختلفة
 */
